function LineGraph(argsMap) {
    ...
    this.slideData = function (newData) {
        ...
        redrawAxes(true);//redrawAxes(false);
        redrawLines(false);//redrawLines(false);
    ...
    var scales = [['linear', 'Linear']]; //var scales = [['linear','Linear'], ['pow','Power'], ['log','Log']];
    ...
    var processDataMap = function (dataMap) {
        ...
        return {
            ...
            "displayScale": getOptionalVar(dataMap, 'displayScale', false),
            "displayData": getOptionalVar(dataMap, 'displayData', false),
            "displayLegend": getOptionalVar(dataMap, 'displayLegend', false),
